...
- PROPOSAL-11: The main agent authors all Telegram proposal text. Consolidation controls the initial operation; later user feedback may change an add, attach, or revise proposal. The agent preserves selected-evidence ownership and the frozen candidate snapshot, then requests approval of the revised proposal before applying it. An attach-evidence proposal does not repeat or replace the existing opinion text. No deterministic renderer applies consolidation results.
