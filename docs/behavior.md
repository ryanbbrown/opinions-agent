...
- PROPOSAL-11: The main agent authors all Telegram proposal text and decides how to use advisory consolidation prose. It must honor the validated keep, attach, or revise operation and its evidence ownership. An attach-evidence proposal does not repeat or replace the existing opinion text. No deterministic renderer applies consolidation results.
