...
- **Split distinct claims instead of over-consolidating:** Broad themes can contain multiple opinions. For example, "AI shifts value toward judgment" and "top builders gain disproportionately from AI" are related but distinct.
- **Use sections to manage related opinions:** The document should support multiple opinions under broader headings rather than forcing one flat list or merging specific takes into vague thesis statements.
