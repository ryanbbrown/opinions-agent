...
- **The bounds.** If the source bounds the claim — a condition, an exception, an explicit "not X" or "only when Y" — the bound is part of the claim. Dropping a caveat or negation changes the opinion.
